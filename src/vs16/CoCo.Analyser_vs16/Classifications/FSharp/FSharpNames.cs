...
namespace CoCo.Analyser.Classifications.FSharp
{
    public static class FSharpNames
    {
        ...
        public const string ModuleBindingValueName = "CoCo fsharp module value name";
        public const string DelegateName = "CoCo fsharp delegate name";
        ...
        public static ImmutableArray<string> All
        {
            get
            {
                ...
                builder.Add(ModuleBindingValueName);
