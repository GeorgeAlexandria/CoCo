...
namespace CoCo.Test.CSharpIdentifiers.Declarations
{
    internal class Methods : CSharpIdentifierTests
    {
        ...
        {
            @"Tests\Identifiers\CSharpIdentifiers\Declarations\Methods\Constructor.cs".GetClassifications(ProjectInfo)
        ...
        {
            @"Tests\Identifiers\CSharpIdentifiers\Declarations\Methods\Destructor.cs".GetClassifications(ProjectInfo)
        ...
        {
            @"Tests\Identifiers\CSharpIdentifiers\Declarations\Methods\Method.cs".GetClassifications(ProjectInfo)
        ...
        {
            @"Tests\Identifiers\CSharpIdentifiers\Declarations\Methods\StaticMethod.cs".GetClassifications(ProjectInfo)
        ...
        {
            @"Tests\Identifiers\CSharpIdentifiers\Declarations\Methods\ExtensionMethod.cs".GetClassifications(ProjectInfo)
        ...
        {
            @"Tests\Identifiers\CSharpIdentifiers\Declarations\Methods\LocalMethod.cs".GetClassifications(ProjectInfo)
        ...
        public void MethodTest_StaticConstructor()
        {
            ...
            @"Tests\Identifiers\CSharpIdentifiers\Declarations\Methods\StaticConstructor.cs".GetClassifications(ProjectInfo)
